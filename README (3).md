...
We take a pre-trained Reinforcement Learning model that solves the
Capacitated Vehicle Routing Problem (CVRP), and use SHAP to explain
WHY the model makes each routing decision.
...
## Key Hypothesis
SHAP will identify DISTANCE as the dominant decision variable —
meaning the RL model mostly picks the nearest unvisited customer.
